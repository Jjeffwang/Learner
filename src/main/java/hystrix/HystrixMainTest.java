...
import hystrix.breaker.CircuitBreaker;
import hystrix.breaker.LocalCircuitBreaker;
...
public class HystrixMainTest {
    ...
    public static void main(String[] args) {
        ...
        final CircuitBreaker circuitBreaker=new LocalCircuitBreaker("5/20", 10, "5/20", 2);
